...
@Controller
@RequestMapping("/admin/lotReport")

public class LotReportController extends HttpServlet {

    @GetMapping(value = "lot")
    @ResponseBody
    public String LotReport(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/lotReport.jasper");
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio de Lotes.pdf");
        response.setContentType("application/x-pdf");
