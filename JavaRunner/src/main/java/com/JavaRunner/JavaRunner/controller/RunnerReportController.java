...
@Controller
@RequestMapping("/admin/runnerReport")

public class RunnerReportController extends HttpServlet {

    @GetMapping(value = "runner")
    @ResponseBody
    public String RunnerReport(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/runnerReport.jasper");
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio de Corredores.pdf");
        response.setContentType("application/x-pdf");
