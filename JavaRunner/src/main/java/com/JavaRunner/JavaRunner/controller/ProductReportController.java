...
public class ProductReportController extends HttpServlet {
    ...
    @ResponseBody
    public String ProductReport(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/productReport.jasper");
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio de Produtos.pdf");
        response.setContentType("application/x-pdf");
