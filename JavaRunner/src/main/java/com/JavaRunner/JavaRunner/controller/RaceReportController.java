...
@Controller
@RequestMapping("/admin/raceReport")

public class RaceReportController extends HttpServlet {

    @GetMapping(value = "race")
    @ResponseBody
    public String RaceReport(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/raceReport.jasper");
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio de Corridas.pdf");
        response.setContentType("application/x-pdf");
