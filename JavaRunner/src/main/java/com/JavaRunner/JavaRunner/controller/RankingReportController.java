...
@Controller
@RequestMapping("/admin/rankingReport")

public class RankingReportController extends HttpServlet {

    @GetMapping(value = "ranking")
    @ResponseBody
    public String RankingReport(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/rankingReport.jasper");
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio de Rankings.pdf");
        response.setContentType("application/x-pdf");
