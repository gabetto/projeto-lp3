...
@Controller
@RequestMapping("/admin/kitReport")

public class KitReportController extends HttpServlet {

    @GetMapping(value = "kit")
    @ResponseBody
    public String KitReport(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/kitReport.jasper");
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio de Kits.pdf");
        response.setContentType("application/x-pdf");
