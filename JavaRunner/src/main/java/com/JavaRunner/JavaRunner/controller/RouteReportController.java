...
@Controller
@RequestMapping("/admin/routeReport")

public class RouteReportController extends HttpServlet {

    @GetMapping(value = "route")
    @ResponseBody
    public String RouteReport(HttpServletResponse response, HttpServletRequest request) throws JRException, IOException, ClassNotFoundException, SQLException {
        ...
        InputStream jasperStream = this.getClass().getResourceAsStream("/reports/routeReport.jasper");
        ...
        response.setHeader("Content-Disposition", "attachment;filename=Relatorio de Percursos.pdf");
        response.setContentType("application/x-pdf");
